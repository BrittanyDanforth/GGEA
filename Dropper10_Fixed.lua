-- Dropper10 - Fixed to use DropperCore (same as Dropper8/9)
...
templateModel.Name = "GreenCubeTemplate10"
...
Core.RunModel({
	...
	namePrefix    = "GreenCube10_",
	dropGroup     = "Drops10",     -- Unique group for Dropper10
	playerGroup   = "Players",
	dropRate      = 0.5,
	cashValue     = 100,
	lifetime      = 2000,
