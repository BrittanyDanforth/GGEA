--[[
	Kuromi Dropper 11 - Legendary Style
	Huge neon with legendary effects
--]]
...
while true do
	...
	drop.Name = "KuromiLegend_" .. dropCount
	drop.Size = Vector3.new(4.5, 4.5, 4.5)
	drop.Material = Enum.Material.Neon
	drop.Color = Color3.fromRGB(130, 80, 180)
	...
	drop.CustomPhysicalProperties = PhysicalProperties.new(0.07, 0.2, 0.3, 1, 1)
	...
	glow.Brightness = 4.5
	glow.Range = 18
	glow.Color = Color3.fromRGB(210, 130, 250)
	glow.Parent = drop
	...
	sparkle.Rate = 40
	sparkle.Lifetime = NumberRange.new(3, 4)
	...
	sparkle.Color = ColorSequence.new(Color3.fromRGB(210, 130, 250))
	sparkle.Parent = drop
	...
	TweenService:Create(drop,
		TweenInfo.new(1.1, Enum.EasingStyle.Elastic, Enum.EasingDirection.Out),
	...
	for i = 1, 6 do
		...
		spawnRing.Color = Color3.fromRGB(210, 130, 250)
