--[[
	Hello Kitty Dropper 2 - Enhanced Style
	Uses DropperCore with proper anti-collision
--]]
...
-- Create template model for dropper 2
local templateModel = Instance.new("Model")
templateModel.Name = "HelloKitty2Template"
