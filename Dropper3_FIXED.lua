--[[
	Hello Kitty Dropper 3 - Premium Style - FIXED COLLISION
	Uses Hello Kitty mesh with red/pink effects
	Fixed: No collision between drops or with players
--]]
...
pcall(function()
	...
	-- FIXED: Orbs DON'T collide with each other
...
while true do
	...
	-- FIXED: CanCollide = false (no collision)
