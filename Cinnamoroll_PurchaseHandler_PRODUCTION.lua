--[[
	✨ Cinnamoroll Purchase Handler - PRODUCTION VERSION
...
local function createMinimalParticles(position)
	...
	emitter.SpreadAngle, emitter.Color, emitter.Size = Vector2.new(15, 15), ColorSequence.new(Color3.fromRGB(180, 210, 235)), NumberSequence.new(0.3)
...
local function resetTycoonPurchases()
	...
	elseif CONFIG.USE_BOUNDING_BOX_FALLBACK then
		...
		print("  ✓ [Cinnamoroll] Destroyed", destroyedCount, "drops")
	end
	Money.Value = 0
...
print("✅ [Cinnamoroll] PRODUCTION VERSION loaded!")
