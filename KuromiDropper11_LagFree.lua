--[[
	Kuromi Dropper 11 - LAG-FREE & OPTIMIZED (Paintball Gun)
...
local FADE_TIME = 0.3  -- Fast fade for less processing
local LIFETIME = 20
...
if not success then
    warn("Kuromi Dropper 11 failed:", errorMsg)
end