--[[
	Kuromi Dropper 4 - Premium Style
	Dark purple with enhanced effects
--]]
...
while true do
	...
	stars.Color = ColorSequence.new(Color3.fromRGB(200, 120, 240))
	stars.Parent = drop
