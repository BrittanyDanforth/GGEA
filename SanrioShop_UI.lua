...
UI.Theme = {
	...
	themes = {
		light = {
			...
			surfaceAlt = Color3.fromRGB(248, 250, 252),
			stroke = Color3.fromRGB(226, 232, 240),
			text = Color3.fromRGB(15, 23, 42),
			textSecondary = Color3.fromRGB(100, 116, 139),
			accent = Color3.fromRGB(147, 51, 234), -- Purple accent for modern look
			accentAlt = Color3.fromRGB(196, 181, 253),
			success = Color3.fromRGB(34, 197, 94),
			warning = Color3.fromRGB(251, 191, 36),
			error = Color3.fromRGB(239, 68, 68),

			-- Character specific colors - more sophisticated palette
			kitty = Color3.fromRGB(236, 72, 153), -- Pink
			melody = Color3.fromRGB(168, 85, 247), -- Purple
			kuromi = Color3.fromRGB(124, 58, 237), -- Deep Purple
			cinna = Color3.fromRGB(59, 130, 246), -- Blue
			pompom = Color3.fromRGB(251, 146, 60), -- Orange
		},
		dark = {
			background = Color3.fromRGB(15, 23, 42),
			surface = Color3.fromRGB(30, 41, 59),
			surfaceAlt = Color3.fromRGB(51, 65, 85),
			stroke = Color3.fromRGB(71, 85, 105),
			text = Color3.fromRGB(248, 250, 252),
			textSecondary = Color3.fromRGB(148, 163, 184),
			accent = Color3.fromRGB(168, 85, 247),
			accentAlt = Color3.fromRGB(147, 51, 234),
			success = Color3.fromRGB(34, 197, 94),
			warning = Color3.fromRGB(251, 191, 36),
			error = Color3.fromRGB(239, 68, 68),

			kitty = Color3.fromRGB(244, 114, 182),
			melody = Color3.fromRGB(196, 181, 253),
			kuromi = Color3.fromRGB(147, 51, 234),
			cinna = Color3.fromRGB(96, 165, 250),
			pompom = Color3.fromRGB(251, 146, 60),
		}
	}
}
