...
Core.Run({
	...
	-- Part properties
	size = Vector3.new(0.230, 0.799, 0.273),  -- JUST A BIT SMALLER (15% of original)
	...
	mesh = {
		...
		scale = Vector3.new(0.15, 0.15, 0.15),  -- JUST A BIT SMALLER
	...
	animation = {
		...
		mesh = {
			startScale = Vector3.new(0.075, 0.075, 0.075),
			endScale = Vector3.new(0.15, 0.15, 0.15),
			duration = 0.6,
