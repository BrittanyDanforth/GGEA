...
Core.Run({
	...
	-- Part properties
	size = Vector3.new(0.275, 0.959, 0.328),  -- 40% MORE SMALLER (18% of original)
	...
	mesh = {
		...
		scale = Vector3.new(0.18, 0.18, 0.18),  -- 40% MORE SMALLER
	...
	animation = {
		...
		mesh = {
			startScale = Vector3.new(0.09, 0.09, 0.09),
			endScale = Vector3.new(0.18, 0.18, 0.18),
			duration = 0.6,
