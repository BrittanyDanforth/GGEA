--[[
	✨ HelloKitty Purchase Handler - FINAL PRODUCTION VERSION
...
local function createMinimalParticles(position)
	...
	emitter.Color = ColorSequence.new(Color3.new(1, 0.8, 0.9))
...
local function resetTycoonPurchases()
	...
	elseif CONFIG.USE_BOUNDING_BOX_FALLBACK then
		...
		print("  ✓ [HelloKitty] Destroyed", destroyedCount, "drops (box)")
	end
	Money.Value = 0
...
print("✅ [HelloKitty] FINAL PRODUCTION VERSION loaded!")
