--[[
	✅ MyMelody Dropper 13 - FIXED VERSION
	Tier: Tiny Drops - HIGHER VALUE!
	Cash: $125 | Rate: 1.5s | Size: 0.2x0.2x0.2
--]]
...
Core.Run({
	...
	dropRate = 1.5,
	cashValue = 125,  -- ✅ HIGHER! $125 instead of $100
	lifetime = 20,
...
print("✅ [MyMelody Dropper 13] Loaded - Higher value drops!")
