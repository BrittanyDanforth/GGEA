-- Dropper9 - Fixed to use DropperCore (same as Dropper8)
...
templateModel.Name = "GreenCubeTemplate9"
...
Core.RunModel({
	...
	namePrefix    = "GreenCube9_",
	dropGroup     = "Drops9",      -- Unique group for Dropper9
	playerGroup   = "Players",
	dropRate      = 0.5,
	cashValue     = 100,
	lifetime      = 2000,
