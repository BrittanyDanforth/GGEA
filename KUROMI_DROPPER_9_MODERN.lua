--[[
	Kuromi Dropper 9 - Modern Mega Style
	✅ Massive purple neon with mega effects
...
while true do
	...
	orb.Name = "KuromiDrop9_" .. orbCount
	orb.Size = Vector3.new(4.5, 4.5, 4.5)
	orb.Material = Enum.Material.Neon
	orb.Color = Color3.fromRGB(150, 100, 200)
	...
	pointLight.Range = 15
	pointLight.Color = Color3.fromRGB(200, 130, 245)
	...
	sparkle.Rate = 35
	sparkle.Lifetime = NumberRange.new(2.5, 4)
	...
	sparkle.Color = ColorSequence.new(Color3.fromRGB(200, 130, 245))
	sparkle.Parent = orb
	...
	for i = 1, 4 do
		...
		spawnRing.Color = Color3.fromRGB(200, 130, 245)
		...
		task.delay(i * 0.08, function()
			TweenService:Create(spawnRing,
				TweenInfo.new(0.8, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
				{Size = Vector3.new(0.1, 13, 13), Transparency = 1}
			):Play()
		end)
