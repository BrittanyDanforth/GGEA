--[[
	✨ Cinnamoroll Purchase Handler - FULL FIXED VERSION (matches HelloKitty)
	
	🛡️ MULTI-TYCOON SAFETY:
	✅ Attribute-based cleanup - Only destroys Cinnamoroll's drops
...
print("✅ [Cinnamoroll] Purchase Handler FULL FIXED VERSION loaded!")
print("🛡️ [Cinnamoroll] Multi-Tycoon Safe: ENABLED")
print("🔧 [Cinnamoroll] All features match HelloKitty handler")
