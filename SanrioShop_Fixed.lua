--[[
    ...
    ✅ CLEAN FIXES: Better text positioning, readable BUY buttons, proper hover contrast
]]
...
local TITLE_X = 70
local DESC_X  = 40
local TITLE_Y = 64      -- was 52 - pushed down for better spacing
local DESC_Y  = 124     -- was 108 - pushed down to match title
local BTN_BOTTOM = -35
...
function Shop:initialize()
	...
	self:setupHandlers()
	print("[SanrioShop] ✅ CLEAN FIXES APPLIED - All updates implemented!")
end
...
function Shop:createProductItem(product, productType, parent)
	...
	-- CLEAN FIX: Make BUY text readable on pastel buttons
	...
	-- CLEAN FIX: Size bump for better readability
	local btsc = Instance.new("UITextSizeConstraint")
	btsc.MinTextSize = 14
	btsc.MaxTextSize = 20   -- was 18; keeps it crisp but not tiny
	btsc.Parent = buyBtn

	-- CLEAN FIX: Keep contrast on hover (darken instead of lighten)
...
print("[SanrioShop_CLEAN_FIXES] ✨ ALL CLEAN FIXES APPLIED!")
print("[SanrioShop_CLEAN_FIXES] 📐 Title: X="..TITLE_X.." Y="..TITLE_Y.." (pushed down)")
print("[SanrioShop_CLEAN_FIXES] 📝 Desc: X="..DESC_X.." Y="..DESC_Y.." (pushed down)")
print("[SanrioShop_CLEAN_FIXES] 🎯 Button: BTN_BOTTOM="..BTN_BOTTOM)
print("[SanrioShop_CLEAN_FIXES] 🔧 BUY text: Deep lavender outline + size bump")
print("[SanrioShop_CLEAN_FIXES] 🎨 Hover: Darkens instead of lightening for contrast")
print("[SanrioShop_CLEAN_FIXES] 🎁 Gift box texture:", GIFT_BOX_TEXTURE_ID)
