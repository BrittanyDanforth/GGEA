--[[
	...
	✅ KEPT: Your ice cream mesh + all effects!
--]]
...
local DROP_GROUP = "CinnamorollOrbs5"
...
local function setupCollisionGroups()
	pcall(function()
		...
		pcall(function() PhysicsService:CollisionGroupSetCollidable(DROP_GROUP, "KuromiOrbs6", false) end)
