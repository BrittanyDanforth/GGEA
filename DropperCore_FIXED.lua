--!strict
-- DropperCore v4.5 — ULTIMATE COLLISION FIX
-- Ensures drops NEVER collide with each other or players, but ARE still collectible
...
local function createFreshDropModel(
	...
	for _, part in ipairs(model:GetDescendants()) do
		if part:IsA("BasePart") then
			...
			part.CanTouch = true
			part.CanQuery = true
			-- CRITICAL FIX: CanCollide = false (prevents collision with players and other drops)
