--[[
	Kuromi Dropper 10 - Ultra Style
	Massive neon orb with ultra effects
--]]
...
while true do
	...
	drop.Name = "KuromiUltra_" .. dropCount
	drop.Size = Vector3.new(4, 4, 4)
	drop.Material = Enum.Material.Neon
	drop.Color = Color3.fromRGB(120, 70, 170)
	...
	sparkle.Rate = 35
	sparkle.Lifetime = NumberRange.new(2.5, 3.5)
	...
	for i = 1, 5 do
		...
		task.delay(i * 0.08, function()
			TweenService:Create(spawnRing,
				...
				{Size = Vector3.new(0.1, 14, 14), Transparency = 1}
			):Play()
		end)
